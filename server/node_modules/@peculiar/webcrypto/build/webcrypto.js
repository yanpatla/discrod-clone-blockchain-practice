...
class ShakeCrypto {
    static digest(algorithm, data) {
        const hash = crypto__default["default"].createHash(algorithm.name.toLowerCase())
            .update(Buffer.from(data)).digest();
        return new Uint8Array(hash).buffer;
    }
}

class Shake128Provider extends core__namespace.ProviderCrypto {
    constructor() {
        super(...arguments);
        this.name = "shake128";
        this.usages = [];
...
class Shake256Provider extends core__namespace.ProviderCrypto {
    constructor() {
        super(...arguments);
        this.name = "shake256";
        this.usages = [];
